...
function Must() {
    ...
    const [contents,Setcontent1]=useState([]);
    ...
    async function fetchData() {
        try {
            let response = await fetch(`http://localhost:5000/works/MustWatchLive`, {
                method: 'get',
    ...
    async function fetchData1() {
        try {
            let response = await fetch(`http://localhost:5000/works/TopStreamers`, {
                method: 'get',
                headers: { 'Content-Type': 'application/json' },
            });
